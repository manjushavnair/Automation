...
import com.automation.ui.connected.elements.common.TrackingOptInModal;
...
public class TrackingOptInPage extends BasePageObject {
    ...
    public static void setGeoCookie(UIWebDriver driver, String continent, String country) {
    ...
    public void acceptOptInModal(UIWebDriver driver, String country, Page page) {
    ...
    public void rejectOptInModal(UIWebDriver driver, String country, Page page) {
        setGeoCookie(driver, EU_CONTINENT, country);
        getUrl(urlOptInModalDisplayedOasis(page));
        modal.clickRejectButton();
    }
