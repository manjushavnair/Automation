...
public class VisualEditorOptionsDialog extends VisualEditorDialog {
    ...
    public void clickLinkResult() {
        //NEEDTOCHECK
        wait.forElementVisibleW(selectedResult);
        WebElement matchingResult = selectedResult.findElement(labelElementBy);
        //NEEDTOCHECK
        wait.forElementVisibleW(matchingResult);
    ...
    private void clickCategory(String searchCategory) {
        ...
        //NEEDTOCHECK
        wait.forElementVisibleW(categoryPopUp);
    }

    public List<WebElement> getLinkResults(String searchStr, VisualEditorDataProvider.CategoryResultType resultType) {
    ...
    public void verifyLinkSuggestions(String searchStr, VisualEditorDataProvider.CategoryResultType resultType) {
