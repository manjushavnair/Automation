...
public class FeaturedVideoDesktopComponentObject extends SiteBasePageObject {
    ...
    public String getSubtitle() {
        //NEEDTOCHECK
        wait.forElementVisibleW(secondaryTitle);
    ...
    public boolean isVideoPlaying() {
        //NEEDTOCHECK
        wait.forElementVisibleW(playerStatePlaying);
    ...
    public boolean isVideoPaused() {
        //NEEDTOCHECK
        wait.forElementVisibleW(playerStatePaused);
    ...
    public boolean isVideoFeedbackDisplayed() {
        //NEEDTOCHECK
        wait.forElementVisibleW(videoFeedback);
