...
public class NotificationsComponentObject extends SiteBasePageObject {
    ...
    private void waitForNotificationsMessagesToLoad() {
        //NEEDTOCHECK
        wait.forElementVisibleW(notificationsDropdown);
    ...
    public void clickNotifications() {
        //NEEDTOCHECK
        wait.forElementVisibleW(notificationsBubbles);
    ...
    private void waitForNotificationsLoaded() {
        //NEEDTOCHECK
        wait.forElementVisibleW(emptyNumberOfUnreadNotifications);
    }
    ...
    public void clickMarkNotificationsAsRead() {
        if (this.getNumberOfUnreadNotifications() > 0) {
            if (this.markNotificationsAsReadThisWiki.isDisplayed()) {
                ...
                //NEEDTOCHECK
                this.wait.forElementVisibleW(this.markNotificationsAsReadAllWikis);
