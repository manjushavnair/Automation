...
public class VideoFanTakeover extends AutoplayVuap {
    ...
    public VideoFanTakeover(UIWebDriver driver, String iframeId, String slotName) {
        this(driver, By.id(iframeId), slotName);
    }

    private VideoFanTakeover(UIWebDriver driver, By iframeSelector, String slotName) {
