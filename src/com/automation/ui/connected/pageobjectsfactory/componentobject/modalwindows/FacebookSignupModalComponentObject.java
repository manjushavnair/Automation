...
public class FacebookSignupModalComponentObject extends SiteBasePageObject {
    ...
    public void clickRegister() {
        //NEEDTOCHECK
        wait.forElementVisibleW(registerButton);
...
//NEEDTOCHECK
        wait.forElementVisibleW(facebookRegistrationForm);
        typeEmail(email);
