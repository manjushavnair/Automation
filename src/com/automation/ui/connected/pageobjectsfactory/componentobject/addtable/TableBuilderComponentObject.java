package com.automation.ui.connected.pageobjectsfactory.componentobject.addtable;
...
public class TableBuilderComponentObject extends SiteBasePageObject {
    ...
    public void selectHeader(Headers header) {
        //NEEDTOCHECK
        wait.forElementVisibleW(tablePropertiesDropdownOptions.get(0));
    ...
    public void selectAlignment(Alignment position) {
        //NEEDTOCHECK
        wait.forElementVisibleW(tablePropertiesDropdownOptions.get(1));
    ...
    public void submitTable() {
        //NEEDTOCHECK
        wait.forElementVisibleW(submitLightboxButton);
