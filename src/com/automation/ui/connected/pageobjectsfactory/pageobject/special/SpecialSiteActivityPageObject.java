...
import com.automation.ui.connected.pageobjectsfactory.componentobject.activity.Activity;
import com.automation.ui.connected.pageobjectsfactory.componentobject.activity.ActivityPageFactory;
import com.automation.ui.connected.pageobjectsfactory.componentobject.activity.ActivityType;
...
public class SpecialSiteActivityPageObject extends SpecialPageObject {
    ...
    public SpecialSiteActivityPageObject open() {
        getUrl(urlBuilder.getUrlForPage(URLsContent.SPECIAL_WIKI_ACTIVITY));
     ...
     * @see com.automation.ui.base.testcases.messagewall.MessageWallTests
     */
