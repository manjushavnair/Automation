package com.automation.ui.connected.pageobjectsfactory.pageobject.special.editaccount;
...
public class EditAccount extends BasePageObject {
    ...
    public EditAccount navigateToSpecialEditAccount(String communityWikiURL) {
        driver.get(communityWikiURL + URLsContent.SITE_DIR + URLsContent.SPECIAL_EDIT_ACCOUNT);
    ...
    public void closeAccount(String reason) {
        ...
        //NEEDTOCHECK
        wait.forElementVisibleW(closeResonField);
    ...
    public void verifyAccountReopenedMessage() {
        //NEEDTOCHECK
        wait.forElementVisibleW(statusMessage);
