...
public class MessageWall extends SiteBasePageObject {
    ...
    public MessageWall open(String userName) {
        getUrl(urlBuilder.getUrlForPage(URLsContent.USER_MESSAGE_WALL + userName));
        waitForPageLoad();
    ...
    public MessageWallAddLinkComponentObject clickLinkButton() {
        ...
        //NEEDTOCHECK
        wait.forElementVisibleW(linkButton);
    ...
    public void verifyThreadRemoved() {
        //NEEDTOCHECK
        wait.forElementVisibleW(removedThreadMessage);
    ...
    public void verifyMessageItalicText(String title, String message, String userName) {
        ...
        //NEEDTOCHECK
        wait.forElementVisibleW(messageTextBox);
    ...
    public void verifyMessageEditText(String title, String message, String userName) {
        //NEEDTOCHECK
        wait.forElementVisibleW(editMessageWrapper);
        WebElement msgBodyTextBox = editMessageWrapper.findElement(messageBodyBy);
        //NEEDTOCHECK
        wait.forElementVisibleW(msgBodyTextBox);
    ...
    public void verifyMessageEditTextRenameDone(String title, String message, String userName) {
        //NEEDTOCHECK
        wait.forElementVisibleW(editMessageWrapper2);
