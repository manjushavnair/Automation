...
import com.automation.ui.connected.common.core.api.ForumBoardContent;
...
import com.automation.ui.connected.pageobjectsfactory.componentobject.photo.PhotoOptionsComponentObject;
...
public class ForumBoardPage extends BasePageObject {
    ...
    public ForumBoardPage open(String forumBoardTitle) {
        getUrl(String.format("%s%s%s:%s", urlBuilder.getUrl(),
                URLsContent.SITE_DIR, URLsContent.FORUM_BOARD_NAMESPACE, forumBoardTitle));
    ...
    public ForumThreadPageObject startDiscussion(String title, String message, boolean highlight) {
        //NEEDTOCHECK
        wait.forElementVisibleW(discussionTitleArea);
        jsActions.focus(discussionTitleArea);
        discussionTitleArea.sendKeys(title);
        wait.forElementVisibleW(wikiaEditorTextArea);
    ...
    public void verifyDiscussionWithImage() {
        //NEEDTOCHECK
        wait.forElementVisibleW(postedImageList.get(0));
