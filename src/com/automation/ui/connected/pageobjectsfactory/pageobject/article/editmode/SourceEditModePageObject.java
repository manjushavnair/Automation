...
import com.automation.ui.connected.common.contentpatterns.WikiaGlobalVariables;
...
import com.automation.ui.connected.pageobjectsfactory.componentobject.wikitextshortcuts.SiteTextShortCutsComponentObject;
...
public class SourceEditModePageObject extends EditMode {
    ...
    public SourceEditModePageObject openArticle(String articleTitle) {
        String url = urlBuilder.getUrl() + URLsContent.SITE_DIR + articleTitle;
    ...
    public SiteTextShortCutsComponentObject clickMore() {
        focusTextArea();
        more.click();
        Log.log("clickMore", "more button was clicked", true, driver);
        return new SiteTextShortCutsComponentObject(driver);
    }
    ...
    public void verifyComponentSelector() {
        //NEEDTOCHECK
        wait.forElementVisibleW(componentSelector);
    ...
    public Object addComponent(String componentName) {
        if ("slideshow".equals(componentName)) {
            //NEEDTOCHECK
            wait.forElementVisibleW(createSlideshow);
            ...
            //NEEDTOCHECK
            wait.forElementVisibleW(createGallery);
            createGallery.click();
            Log.log("addComponent", "selected " + componentName + " component", true);
            return new GalleryBuilderComponentObject(driver);
        } else if ("slider".equals(componentName)) {
            //NEEDTOCHECK
            wait.forElementVisibleW(createSlider);
            createSlider.click();
            Log.log("addComponent", "selected " + componentName + " component", true);
    ...
    public void verifyVideoAlignment(BasePageObject.PositionsVideo position) {
    ...
    public void verifySourceOnlyMode() {
        //NEEDTOCHECK
        wait.forElementVisibleW(sourceOnlyModeTextArea);
        if (!(Boolean) jsActions.execute(WikiaGlobalVariables.WG_IS_ARTICLE)) {
            //NEEDTOCHECK
            wait.forElementVisibleW(srcOnlyMode);
