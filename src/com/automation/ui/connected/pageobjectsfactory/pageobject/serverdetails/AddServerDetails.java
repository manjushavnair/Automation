    ...
    public void  provideAllServerDetails(Map<String, Object> connInfo) {
        ...
        try {
          ...
          //  provideServerSecurityCheckDisable();
           ...
           /*
           *
           * <label for="s1" class="ng-binding"><span></span>All tags</label>
<label for="s2" class="ng-binding"><span></span>Filtered list of tags</label>
<button class="primaryLink " ng-init="isHower = false">
                                ...
                                <button class="primary next ng-binding" ng-click="steps.nextClick()" ng-mousedown="steps.nextMousedown()">Next</button>

                                <a class="cloud icon" alt="CloudDataMenu">Cloud Data</a>
                                <button class="link back ng-binding" ng-click="steps.backClick()">Back</button>
           * */
