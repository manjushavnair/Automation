...
import com.automation.ui.connected.pageobjectsfactory.componentobject.visualeditordialogs.*;
...
public class VisualEditorMenu extends SiteBasePageObject {
    ...
    private void clickStyleItemFromDropDown(By styleBy) {
        ...
        //NEEDTOCHECK
        wait.forElementVisibleW(styleListElement);
        Actions actions = new Actions(driver);
        actions.click(styleListElement).click(styleItems.findElement(styleBy)).build().perform();
    }

    public void selectStyle(VisualEditorDataProvider.Style style) {
        switch (style) {
            case BOLD:
                boldButton.click();
                break;
    ...
    public void selectFormatting(VisualEditorDataProvider.Formatting format) {
        switch (format) {
            case PARAGRAPH:
    ...
    public void selectIndentation(VisualEditorDataProvider.Indentation indent) {
        switch (indent) {
            case INCREASE:
    ...
    public VisualEditorDialog openDialogFromMenu(VisualEditorDataProvider.InsertDialog insert) {
        switch (insert) {
            case REFERENCE:
    ...
    public void insertList(VisualEditorDataProvider.InsertList insert) {
        switch (insert) {
            case BULLET_LIST:
    ...
    public VisualEditorSaveChangesDialog clickPublishButton() {
        ...
        //NEEDTOCHECK
        wait.forElementVisibleW(enabledPublishButton);
    ...
    public void verifyVEToolBarPresent() {
        ...
        wait.forElementVisibleW(veToolMenu);
