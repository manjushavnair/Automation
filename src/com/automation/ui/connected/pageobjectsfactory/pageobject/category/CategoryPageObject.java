package com.automation.ui.connected.pageobjectsfactory.pageobject.category;
...
public class CategoryPageObject extends SiteBasePageObject {
    ...
    public String getCategoryPageTitle() {
        //NEEDTOCHECK
        wait.forElementVisibleW(this.articleTitle);
