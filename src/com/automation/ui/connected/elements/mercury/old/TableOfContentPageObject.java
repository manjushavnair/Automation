...
public class TableOfContentPageObject {
    ...
    public boolean isTOCAtTheTopOfTheArticle() {
        //NEEDTOCHECK
        wait.forElementVisibleW(tocAtTheTop);
    ...
    public boolean isTOCBelowFirstAdSlot() {
        //NEEDTOCHECK
        wait.forElementVisibleW(tocBelowFirstAdSlot);
    ...
    public void clickOnTOC() {
        //NEEDTOCHECK
        wait.forElementVisibleW(tocButton);
        tocButton.click();
    }

    public void clickOnTOCListElement(int index) {
        //NEEDTOCHECK
        wait.forElementVisibleW(listOfLinks.get(index));
    ...
    public boolean isUserMovedToSectionByIndex(String sectionIndex) {
        ...
        wait.forElementVisibleW(section);
        return true;
    }
