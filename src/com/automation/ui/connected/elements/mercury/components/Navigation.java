...
import com.automation.ui.connected.pageobjectsfactory.pageobject.auth.JoinTodayPage;
...
public class Navigation extends SiteBasePageObject {
    ...
    public boolean isUserAvatarVisible(final String username) {
        //NEEDTOCHECK
        return wait.forElementVisibleW(userAvatarImg).isDisplayed() && userAvatarImg.getAttribute("alt").equals(username);
    }
