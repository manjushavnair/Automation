...
public class Post extends BasePage {
    ...
    public Post waitForPostToAppearWithOpenGraph(final String url) {
        ...
        new FluentWait<>(driver)
                ...
                .until(
                        (Function<UIWebDriver, Boolean>) input -> wait.forElementVisibleW(postOpenGraph)
                                .getAttribute("href")
                                .contains(url)
                );
        return this;
    ...
    public String getPostDetailsVoteCount() {
        //NEEDTOCHECK
        wait.forElementVisibleW(upvoteArea);
    ...
    public boolean isUpvoteButtonVisible() {
        wait.forElementVisibleW(upvoteButton);
        return upvoteButton.isDisplayed();
    }

    public String getPostDetailText() {
        return wait.forElementVisibleW(postDetails).getText();
    }
