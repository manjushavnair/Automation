...
import com.automation.ui.base.elements.FrameScope;
import com.automation.ui.connected.common.contentpatterns.TemplateTypes;
import com.automation.ui.connected.elements.oasis.pages.TemplateEditPage;
...
public class InfoboxBuilderPage extends SpecialPageObject {
    ...
    public InfoboxBuilderPage openNew(String templateName) {
        getUrl(urlBuilder
                .appendQueryStringToURL(urlBuilder.getUrlForPage("Template:" + templateName),
        ...
        //NEEDTOCHECK
        wait.forElementVisibleW(previewArea);
    ...
    public InfoboxBuilderPage openExisting(String templateName) {
        getUrl(
                urlBuilder.appendQueryStringToURL(
                        urlBuilder.getUrlForPage(URLsContent.SPECIAL_INFOBOX_BUILDER + "/" + templateName),
                        URLsContent.ACTION_EDIT));
        driver.switchTo().frame(builderIFrame);
    ...
    public InfoboxBuilderPage open() {
        ...
        getUrl(urlBuilder.getUrlForPage(URLsContent.SPECIAL_INFOBOX_BUILDER));
        driver.switchTo().frame(builderIFrame);
        //NEEDTOCHECK
        wait.forElementVisibleW(previewArea);
    ...
    public void inBuilderFrame(FrameScope frameScope) {
        //NEEDTOCHECK
        wait.forElementVisibleW(builderIFrame);
    ...
    public boolean isGoToSourceModalPresent() {
        //NEEDTOCHECK
        wait.forElementVisibleW(modalGoToSource);
    ...
    public boolean isModalEditTitlePresent() {
        //NEEDTOCHECK
        wait.forElementVisibleW(modalEditTitle);
    ...
    public boolean isEditTemplateTitleInputPresent() {
        //NEEDTOCHECK
        wait.forElementVisibleW(editTemplateTitleInput);
    ...
    public boolean isErrorMessagePresent() {
        //NEEDTOCHECK
        wait.forElementVisibleW(errorMessage);
    ...
    public boolean isSectionTooltipPresentAbove(int index) {
        ...
        //NEEDTOCHECK
        wait.forElementVisibleW(sectionTooltipOrientedAbove);
    ...
    public boolean isSectionTooltipPresentBelow(int index) {
        hoverOverSectionChevron(index);
        //NEEDTOCHECK
        wait.forElementVisibleW(sectionTooltipOrientedBelow);
    ...
    public String getLabelText(int index) {
        //NEEDTOCHECK
        wait.forElementVisibleW(rowLabels.get(index));
    ...
    public String getComponentBackgroundColor(int index) {
        //NEEDTOCHECK
        wait.forElementVisibleW(component.get(index));
    ...
    public InfoboxBuilderPage hoverMouseOverComponent(int index) {
        //NEEDTOCHECK
        wait.forElementVisibleW(component.get(0));
    ...
    public boolean isTooltipVisible() {
        try {
            //NEEDTOCHECK
            wait.forElementVisibleW(tooltip);
            return true;
    ...
    public InfoboxBuilderPage moveToLastComponent() {
        ...
        //NEEDTOCHECK
        wait.forElementVisibleW(lastComponent);
    ...
    public void hoverOverSectionChevron(int index) {
        //NEEDTOCHECK
        wait.forElementVisibleW(sectionHeadersChevron.get(index));
