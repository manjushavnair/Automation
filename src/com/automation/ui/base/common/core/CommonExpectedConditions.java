...
import com.automation.ui.base.common.core.imageutilities.ImageComparison;
...
public class CommonExpectedConditions {
    ...
    private static org.apache.log4j.Logger LOGGER = org.apache.log4j.Logger.getLogger(CommonExpectedConditions.class.getName());
    ...
    /**
     * An expectation for checking if attribute is present in the element.
     */
    ...
    private static WebElement findElement(By by, WebDriver driver) {
        try {
            ...
            LOGGER.log(Level.INFO, String.format("WebDriverException thrown by findElement(%s)", by),
                    e);
            throw e;
        }
    }
        ...
        return new ExpectedCondition<Boolean>() {
            public Boolean apply(WebDriver driver) {
                try {
                    ...
                    driver.manage().timeouts().implicitlyWait(BASEConstants.WAITTIME15SEC, TimeUnit.SECONDS);
                    return !isDisplayed;
                } catch (StaleElementReferenceException e) {
